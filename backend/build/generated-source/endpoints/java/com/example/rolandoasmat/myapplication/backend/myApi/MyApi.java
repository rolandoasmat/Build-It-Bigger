 ...
 * on 2017-08-18 at 12:23:04 UTC 
 * Modify at your own risk.
 */

package com.example.rolandoasmat.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getPun".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetPun#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetPun getPun() throws java.io.IOException {
    GetPun result = new GetPun();
    initialize(result);
    return result;
  }

  public class GetPun extends MyApiRequest<com.example.rolandoasmat.myapplication.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link GetPun#execute()} method to invoke the remote operation. <p> {@link
     * GetPun#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
     * be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetPun() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.rolandoasmat.myapplication.backend.myApi.model.MyBean.class);
    }
    ...
    @Override
    public GetPun setAlt(java.lang.String alt) {
      return (GetPun) super.setAlt(alt);
    }

    @Override
    public GetPun setFields(java.lang.String fields) {
      return (GetPun) super.setFields(fields);
    }

    @Override
    public GetPun setKey(java.lang.String key) {
      return (GetPun) super.setKey(key);
    }

    @Override
    public GetPun setOauthToken(java.lang.String oauthToken) {
      return (GetPun) super.setOauthToken(oauthToken);
    }

    @Override
    public GetPun setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetPun) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetPun setQuotaUser(java.lang.String quotaUser) {
      return (GetPun) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetPun setUserIp(java.lang.String userIp) {
      return (GetPun) super.setUserIp(userIp);
    }

    @Override
    public GetPun set(String parameterName, Object value) {
      return (GetPun) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.rolandoasmat.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.rolandoasmat.myapplication.backend.myApi.model.MyBean.class);
